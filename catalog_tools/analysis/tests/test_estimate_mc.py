...
def test_empirical_cdf():
    ...
    xs = np.array([0.00549466, 0.00929412, 0.01606361, 0.01760724, 0.03163823,
                   0.06441641, 0.0685186, 0.15884389, 0.17295367, 0.20449985,
                   0.21032875, 0.2446928, 0.29659387, 0.29912548, 0.30893407,
                   0.34412639, 0.38877039, 0.38891402, 0.39710704, 0.45248849,
                   0.47025982, 0.47726263, 0.51067202, 0.51430296, 0.51640171,
                   0.5286394, 0.52866666, 0.54332513, 0.55325218, 0.6113724,
                   0.64488555, 0.64555887, 0.67863794, 0.68900707, 0.71962906,
                   0.72307647, 0.72807291, 0.76630311, 0.84463611, 0.86879564,
                   0.8839698, 0.88983565, 0.90675099, 0.91309795, 0.91615602,
                   0.91730252, 0.93026383, 0.95291164, 0.98729853, 0.9886478])
...
def test_estimate_mc():
    mags = np.array([2.3, 1.2, 1.5, 1.2, 1.7, 1.1, 1.2, 1.5, 1.8, 1.6, 1.2, 1.5, 1.2,
                     1.7, 1.6, 1.1, 1.1, 1.2, 2., 1.1, 1.2, 1.1, 1.2, 1.6, 1.9, 1.3,
                     1.7, 1.3, 1., 1.2, 1.7, 1.3, 1.3, 1.1, 1.5, 1.4, 1.1, 2.1, 1.2,
                     2.2, 1.7, 1.6, 1.1, 2., 2.1, 1.2, 1., 1.5, 1.2, 1.7, 1.8, 1.1,
                     1.3, 1.1, 1.3, 1.4, 2.1, 2., 1.1, 2.2, 1.8, 1.4, 1.1, 1., 2.,
                     2., 1.1, 1., 1., 1.5, 1.6, 3.7, 2.8, 1.5, 1.1, 1.2, 1.4, 2.3,
                     1.5, 1.2, 1.7, 1.1, 1.6, 1.2, 1.5, 1.1, 1.2, 1.7, 1.2, 1.6, 1.2,
                     1.1, 1.8, 1.2, 1.1, 1., 1.3, 1.1, 1.6, 1.6])
    ...
    assert_allclose([0.2819699492277921,
                     0.21699092832299466,
                     0.11605633802816911,
