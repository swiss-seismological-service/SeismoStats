...
def get_cum_fmd(
    ...
    Note that the returned bins array contains the center point of each bin unless left is True.
    Moreover, note that all bins except for the last are half-open in np.histogram
