...
@pytest.mark.parametrize(
    ...
    [
        ...
        (np.array([0.05, -0.05, 0.15, -0.15]), 0.1, np.array([0.1, -0.1, 0.2, -0.2])),
        (np.array([2.5, 4.5, 6.5, -2.5, -4.5]), 1.0, np.array([3, 5, 7, -3, -5])),
        (np.array([1.25, 1.75, -1.25, -1.75]), 0.5, np.array([1.5, 2.0, -1.5, -2.0])),
        (np.array([0.3, 0.35, 0.45, 0.55]), 0.1, np.array([0.3, 0.4, 0.5, 0.6])),
        (np.array([2.26, 2.24, 2.25]), 0.05, np.array([2.25, 2.25, 2.25])),
        (np.array([2.275, 2.225]), 0.05, np.array([2.3, 2.25])),
        (np.array([0.2, 0.4, 1.6, -2.0]), 0.2, np.array([0.2, 0.4, 1.6, -2.0])),
        (np.array([0.00075, -0.00075]), 0.0005, np.array([0.001, -0.001])),
    ]
)
...
@pytest.mark.parametrize(
    "magnitudes, fmd_bin, bins, c_counts, bin_position",
...
def test_get_cum_fmd(magnitudes: np.ndarray, fmd_bin: float,
